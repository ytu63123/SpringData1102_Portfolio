...
public class SendEmail {
    public static void main(String[] args) throws Exception {
        String personal = "來來喔"; // 發送者姓名
        String to = "ytu6312356@gmail.com"; // 發送給誰 ? 若有多筆", "號隔開
        String title = "測試"; // 信件 title
        // 信件內容 
    ...
    public void submit(String personal, String to, String title, String html) throws Exception {
        ...
        final String googleGmail = "ytu6312356@gmail.com"; // 你的 Gmail
        final String authPassword = "tlrupcyzjirgagof"; // 你的授權碼
        ...
        InternetAddress ia = new InternetAddress("ytu6312356@gmail.com"); // 你的 Gmail
